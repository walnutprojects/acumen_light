...

{
    ...
    'description': 'Send CRM Leads. Real All in One. Send and receive messages. Real ChatRoom. WhatsApp integration. WhatsApp Connector. apichat.io. GupShup. Chat-Api. ChatApi. Drag and Drop.',
    'version': '15.0.1',
    'author': 'AcruxLab',
